...
const CATALOG = [
  ...
  },
  {
    ...
    name: "Kubecost",
    category: "Custos",
    description: "Monitoramento de custos em tempo real para Kubernetes. Fornece breakdown detalhado por namespace, deployment, pod e label. Integra com AWS, GCP e Azure para otimizar gastos.",
    maintainer: "Kubecost",
